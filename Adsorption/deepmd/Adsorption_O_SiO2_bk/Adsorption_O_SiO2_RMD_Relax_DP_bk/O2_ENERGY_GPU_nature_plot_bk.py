...
def read_adsorption_data(filename):
    ...
    try:
        ...
        # 列索引
        # 0: Step, 1: Temp, 2: PE, 3: KE, 4: Etotal, 5: E_total, 6: Atoms, 
        # 7: Type3_O, 8: Type3_O_added, 9: Coverage, 10: Coverage_added, 
        # 11: Delta_E, 12: E_O_contrib, 13: E_ads, 14: E_ads_per_O
        ...
        return {
            ...
            'Type3_O': selected_data[:, 7],
            'Coverage': selected_data[:, 9],
            'E_ads_per_O': selected_data[:, 14]
        }
