...
mpirun -n 1 lmp_mpi -k on g 1 -sf kk -pk kokkos newton on neigh half -in in.flux_beta_long_box_abs_gcmc_temperature800 >log.lammps_beta_long_box_abs_gcmc_temperature800