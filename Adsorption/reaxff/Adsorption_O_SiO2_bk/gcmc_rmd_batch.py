...
# 源文件路径
SOURCE_DIR = "/home/bingxing2/home/scx7113/DEEPMD_PROJECT/yxb_test_20241109_clean_2_20251013_MD_reaxff/Adsorption_O_SiO2_GCMC_RMD_DP_bk"
...
def prepare_and_submit_gcmc(temperature, pressure):
    ...
    # 4. 修改LAMMPS输入文件
    input_file = os.path.join(work_dir, "in.flux_beta_long_box_abs_gcmc_reaxff")
