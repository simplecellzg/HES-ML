...
# 定义源文件目录和文件列表
src_dir="/public1/home/sch9516/ZG/MTD_3_database_trained_post_result/backup"
...
files_to_copy=("input.lammps" "sio2_surf_o_slab_240_addH_opt.lmp" "get_last_xyz.sh" "graph_compressed_20241109_clean_2.pb" "submit_lmp.sh" "submit_xtb.sh" "xyz_wrap.sh" "submit_xyz_wrap.sh" "plt_reconstruct.gp" "plumed_SiO_surf_reconstruct.dat")
